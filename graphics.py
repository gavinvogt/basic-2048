...
class graphics:
    ...
    def setup_kill_events(self):
        kill_wind = lambda e: self.primary.destroy()
    ...
    def set_left_click_action(self, callee, board):
        ...
        def left_click_action(event):
            callee(self, event.x, event.y, board)
    ...
    def set_keyboard_action(self, callee, board):
        ...
        def keyboard_action(event):
            callee(self, event.keycode, board)
